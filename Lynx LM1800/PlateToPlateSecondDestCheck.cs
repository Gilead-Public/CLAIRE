...
public class MMScriptExecutor : IMMScriptExecutor
{
	...
	public void Execute(IMMApp app)
	{
		...
		// Pull in scanned barcodes and dest list
		var list1 = app.GetVariableValue("SecondDestCodes").Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
		var list2 = app.GetVariableValue("SecondDestList").Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
