...
public class MMScriptExecutor : IMMScriptExecutor
{
	...
	public void Execute(IMMApp app)
	{
		...
		app.SetVariable("DestLabware", "96 ViCell Plate");
		...
		int sourceCount = int.Parse(app.GetVariableValue("SourceCount"))+1;	
		int destCount = int.Parse(app.GetVariableValue("DestCount"))+1;
