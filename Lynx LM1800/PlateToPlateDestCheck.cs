...
public class MMScriptExecutor : IMMScriptExecutor
{
	...
	public void Execute(IMMApp app)
	{
		...
		var list1 = app.GetVariableValue("DestCodes").Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
		var list2 = app.GetVariableValue("DestList").Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
